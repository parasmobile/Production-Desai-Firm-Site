...
const ChildCustody = () => (
  <PracticeAreaLayout
    ...
    seoTitle="Child Custody Attorney Saint Augustine FL | The Desai Firm"
    seoDescription="Saint Augustine child custody and timesharing attorney. Paras J. Desai helps parents navigate parental responsibility, custody disputes, and parenting plans in Florida courts."
    canonical="https://desaifirm.com/practice-areas/family-law/child-custody"
    breadcrumb="Practice Areas / Family Law / Child Custody"
    heroSubtitle="Protecting your parental rights and your child's best interests across St. Johns County and Northeast Florida."
    overview={
      <>
        <p>
          Child custody disputes are among the most emotionally charged and legally complex matters a parent can face. In Florida, the law doesn't use the term "custody" — instead, it uses <strong>parental responsibility</strong> (decision-making authority) and <strong>timesharing</strong> (the schedule of when each parent has the child). Understanding this distinction and how Florida courts apply it is critical to protecting your rights.
        </p>
        <p>
    ...
    faqs={[
      {
        q: "How does Florida determine child custody?",
        a: "Florida courts determine timesharing and parental responsibility based on the 'best interests of the child' standard. Judges evaluate 20 specific statutory factors including each parent's ability to meet the child's needs, the child's established routine and school record, the mental and physical health of each parent, the willingness of each parent to support the child's relationship with the other parent, and evidence of domestic violence or substance abuse. There is no automatic preference for mothers over fathers."
      },
      {
        q: "Can a timesharing order be changed after it's entered?",
        a: "Yes, but the burden is significant. To modify a final timesharing order, the requesting parent must show a substantial, material, and unanticipated change in circumstances since the last order was entered, and that the modification is in the best interests of the child. Common grounds include relocation, a parent's substance abuse issue, or a major change in the child's needs or school situation."
      },
      {
        q: "What is a parenting plan in Florida?",
        a: "A parenting plan is a court-approved document that governs how parents share responsibility for their child. It must address: (1) how daily tasks and decision-making responsibility will be divided; (2) the timesharing schedule in detail, including weekdays, weekends, holidays, and school breaks; (3) which parent designates the child's primary residence for school enrollment purposes; and (4) how parents will communicate about the child. All parents going through a Florida family court proceeding involving children must have an approved parenting plan."
      },
      {
        q: "What happens if the other parent violates the parenting plan?",
        a: "If the other parent repeatedly fails to comply with the court-ordered timesharing schedule, you can file a motion for enforcement. Florida courts take violations seriously — the court can order makeup timesharing, require the violating parent to pay your attorney's fees, or impose other sanctions. In serious or repeated cases, the court may modify the timesharing order in your favor."
      },
      {
        q: "Do I need an attorney for a child custody case?",
        a: "You are not required to have an attorney, but the stakes in a custody case — your relationship with your child and your parental rights — are too important to leave to chance. The parenting plan entered by the court can be very difficult to modify later. An attorney can help you avoid common mistakes, protect your rights in mediation, and ensure the parenting plan reflects your actual goals and your child's needs."
      },
    ]}
  />
);

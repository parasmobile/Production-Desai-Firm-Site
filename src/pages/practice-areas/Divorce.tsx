...
const Divorce = () => (
  <PracticeAreaLayout
    ...
    seoTitle="Divorce Attorney Saint Augustine FL | The Desai Firm"
    seoDescription="Saint Augustine divorce attorney Paras J. Desai handles contested and uncontested divorce, asset division, alimony, and property disputes in St. Johns County and Northeast Florida."
    canonical="https://desaifirm.com/practice-areas/family-law/divorce"
    breadcrumb="Practice Areas / Family Law / Divorce"
    heroSubtitle="Straightforward legal guidance through contested and uncontested divorce in Saint Augustine and Northeast Florida."
    overview={
      <>
        <p>
